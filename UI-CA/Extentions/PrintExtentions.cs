...
public static class PrintExtentions
{
    ...
    public static String PrintFastestLapDetails(FastestLap lap)
    {
        ...
        return
            $"Lap at {lap.Circuit} with a {formattedLapTime} by {lap.Car.Chasis} of team {lap.Car.Team}, using a {lap.Car.Tyres} tyre compound driven at {formattedDate}, Under the conditions of AirTemp: {lap.AirTemperature} and TrackTemp: {lap.TrackTemperature}";
    }
}